                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6">
                            <div class="short_contact_list">
                                <ul>
                                    <li><a href="#"> <i class="fa fa-envelope"></i> info@medcare.com</a></li>
                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="<?php echo e(url('Hospital/index')); ?>">Hospitals</a></li>
                                        <li><a href="<?php echo e(url('Plan/index')); ?>">Plans</a></li>
                                        ...
                                        <li><a href="#">pages <i class="ti-angle-down"></i></a>
                                            <ul class="submenu">
                                                <li><a href="<?php echo e(url('Home/login')); ?>">login</a></li>
                        ...
                        <div class="col-xl-3 col-lg-3 d-none d-lg-block">
                            <div class="Appointment">
                                <div class="book_btn d-none d-lg-block">
                                    ...
                                    <!-- <a class="popup-with-form" href="<?php echo e(url('Home/login')); ?>">Make an Appointment</a> -->
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
...
</html><?php /**PATH C:\xampp\htdocs\medcare\medcare\resources\views/index.blade.php ENDPATH**/ ?>